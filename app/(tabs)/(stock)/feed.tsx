...
const AutomotiveRSSFeed: React.FC = () => {
  ...
  const [sourceTitle, setSourceTitle] = useState<string>("CarAdvice Australia");
  const [rssUrl, setRssUrl] = useState<string>("https://www.caradvice.com.au/feed/");
  ...
  const handleReadMore = (url: string) => {
    router.push({ pathname: "(stock)/feed-readmore", params: { uri: url } });
    // setSelectedUrl(url);
  };
